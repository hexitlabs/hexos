...
HexOS has two separate “streaming” layers:
...
When block streaming is enabled, HexOS can **merge consecutive block chunks**
...
When draft streaming is active, HexOS disables block streaming for that reply to avoid double-streaming.
