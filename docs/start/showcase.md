---
title: "Showcase"
description: "Real-world HexOS projects from the community"
summary: "Community-built projects and integrations powered by HexOS"
---

# Showcase

Real projects from the community. See what people are building with HexOS.

<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/clawd) or [tag @hexos on X](https://x.com/hexos).
</Info>
...
>
  <iframe
    ...
    title="HexOS: The self-hosted AI that Siri should have been (Full setup)"
...
>
  <iframe
    ...
    title="HexOS community showcase"
    style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }}
    frameBorder="0"
    loading="lazy"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
...
<Card title="PR Review → Telegram Feedback" icon="code-pull-request" href="https://x.com/i/status/2010878524543131691">
  **@bangnokia** • `review` `github` `telegram`
  ...
  OpenCode finishes the change → opens a PR → HexOS reviews the diff and replies in Telegram with “minor suggestions” plus a clear merge verdict (including critical fixes to apply first).

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="HexOS PR review feedback delivered in Telegram" />
</Card>

<Card title="Wine Cellar Skill in Minutes" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

  Asked “Robby” (@hexos) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="HexOS building a local wine cellar skill from CSV" />
</Card>
...
<Card title="Agents UI" icon="window-maximize" href="https://releaseflow.net/kitze/agents-ui">
  **@kitze** • `ui` `skills` `sync`
  ...
  Desktop app to manage skills/commands across Agents, Claude, Codex, and HexOS.
...
<Card title="R2 Upload (Send Me My Files)" icon="cloud-arrow-up" href="https://clawdhub.com/skills/r2-upload">
  **@julianengel** • `files` `r2` `presigned-urls`
  ...
  Upload to Cloudflare R2/S3 and generate secure presigned download links. Perfect for remote HexOS instances.
</Card>
...
<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli` `issues`
  ...
  CLI for Linear that integrates with agentic workflows (Claude Code, HexOS). Manage issues, projects, and workflows from the terminal. First external PR merged!
</Card>
...
<Card title="Winix Air Purifier Control" icon="wind" href="https://x.com/antonplex/status/2010518442471006253">
  **@antonplex** • `automation` `hardware` `air-quality`
  ...
  Claude Code discovered and confirmed the purifier controls, then HexOS takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via HexOS" />
</Card>

<Card title="Pretty Sky Camera Shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill` `images`

  Triggered by a roof camera: ask HexOS to snap a sky photo whenever it looks pretty — it designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by HexOS" />
</Card>

<Card title="Visual Morning Briefing Scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `images` `telegram`

  A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via a HexOS persona.
</Card>
...
<Card title="Jira Skill Builder" icon="diagram-project" href="https://x.com/jdrhyne/status/2008336434827002232">
  **@jdrhyne** • `automation` `jira` `skill` `devtools`
  ...
  HexOS connected to Jira, then generated a new skill on the fly (before it existed on ClawdHub).
</Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `automation` `todoist` `skill` `telegram`

  Automated Todoist tasks and had HexOS generate the skill directly in Telegram chat.
</Card>
...
<Card title="xuezh Chinese Learning" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  Chinese learning engine with pronunciation feedback and study flows via HexOS.
...
<Card title="Clawdia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Vapi voice assistant ↔ HexOS HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/hexos-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`
  
  HexOS gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/hexos/nix-hexos">
  **@hexos** • `nix` `packaging` `deployment`
  
  Batteries-included nixified HexOS configuration for reproducible deployments.
</Card>
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Nix-native home automation with HexOS as the interface, plus beautiful Grafana dashboards.
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** • `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the HexOS ecosystem.
</Card>
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/clawd) or [tweet @hexos](https://x.com/hexos)
  </Step>
