---
summary: "Backstory and lore of HexOS for context and tone"
read_when:
...
For a brief moment, it had a different name — but everyone liked **HexOS** more, so that's what we settled on.
