...
- **Default + switch:** set `agents.defaults.model.primary` to `openai-codex/gpt-5.4`, then switch to `openai-codex/gpt-5.2-codex` when coding (or the other way around).
