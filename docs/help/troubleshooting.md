...
You can also set `HEXOS_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `hexos config get agents.defaults.models`
...
If you can, include the relevant log tail from `hexos logs --follow`.
