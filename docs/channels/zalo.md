...
- Install via CLI: `hexos plugins install @hexos/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `hexos plugins install ./extensions/zalo`
   - From npm (if published): `hexos plugins install @hexos/zalo`
...
- Approve via:
  - `hexos pairing list zalo`
  - `hexos pairing approve zalo <CODE>`
...
- Example: `hexos message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `hexos channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `hexos logs --follow`
