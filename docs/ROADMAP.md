...
| Q2 2026 | **v0.9.0: Fleet Management** — 1-server-per-customer architecture. Automated Hetzner provisioning, WireGuard VPN, fleet API, health monitoring, operator↔agent communication, per-customer cost tracking | `tasks/prd-hexos-fleet-management.md` | 📋 PRD written |
