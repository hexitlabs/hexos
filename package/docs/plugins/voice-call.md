...
read_when:
  - You want to place an outbound voice call from HexOS
  - You are configuring or developing the voice-call plugin
---

# Voice Call (plugin)

Voice calls for HexOS via a plugin. Supports outbound notifications and
...
- Use `hexos voicecall ...` or the `voice_call` tool
...
```bash
hexos plugins install ./extensions/voice-call
