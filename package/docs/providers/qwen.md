---
summary: "Use Qwen OAuth (free tier) in HexOS"
read_when:
  - You want to use Qwen with HexOS
...
```bash
hexos models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, HexOS will sync credentials
