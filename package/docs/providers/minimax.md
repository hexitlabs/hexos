---
summary: "Use MiniMax M2.1 in HexOS"
read_when:
  - You want MiniMax models in HexOS
...
Configure manually via `hexos.json`:
...
- Use `hexos models list` and `hexos models set minimax/MiniMax-M2.1` to switch.
...
- Running `hexos configure` and selecting **MiniMax M2.1**, or
