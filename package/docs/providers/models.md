---
summary: "Model providers (LLMs) supported by HexOS"
read_when:
...
HexOS can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `hexos onboard`).
