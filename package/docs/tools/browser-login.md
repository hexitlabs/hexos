...
HexOS controls a **dedicated Chrome profile** (named `clawd`, orange‑tinted UI). This is separate from your daily browser profile.
...
```bash
hexos browser start
hexos browser open https://x.com
```
...
```bash
hexos browser open https://x.com --browser-profile clawd --target host
```
