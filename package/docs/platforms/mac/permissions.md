...
- Same path: run the app from a fixed location (for HexOS, `dist/HexOS.app`).
...
```bash
sudo tccutil reset Accessibility com.hexos.mac
sudo tccutil reset ScreenCapture com.hexos.mac
