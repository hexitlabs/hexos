...
HexOS ships three update channels:
...
When you **explicitly** switch channels with `--channel`, HexOS also aligns
the install method:
...
When you switch channels with `hexos update`, HexOS also syncs plugin sources:
