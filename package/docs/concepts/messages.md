...
This page ties together how HexOS handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. HexOS keeps a
...
HexOS separates the **prompt body** from the **command body**:
...
HexOS can expose or hide model reasoning:
