...
read_when:
  ...
  - Deciding: standalone CLI vs deep HexOS integration
...
Recommendation: **deep integration in HexOS**, but keep a separable core library.

### Why integrate into HexOS?
- HexOS already knows:
  - the workspace path (`agents.defaults.workspace`)
  - the session model + heartbeats
  - logging + troubleshooting patterns
- You want the agent itself to call the tools:
  - `hexos memory recall "…" --k 25 --since 30d`
  - `hexos memory reflect --since 7d`
