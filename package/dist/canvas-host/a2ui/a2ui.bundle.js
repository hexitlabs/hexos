...
var HexOSA2UIHost = class extends i$6 {
	static properties = {
		surfaces: { state: true },
    ...
    :host {
      ...
      box-sizing: border-box;
      padding:
        var(--hexos-a2ui-inset-top, 0px)
        var(--hexos-a2ui-inset-right, 0px)
        var(--hexos-a2ui-inset-bottom, 0px)
        var(--hexos-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--hexos-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--hexos-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--hexos-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--hexos-a2ui-empty-top, var(--hexos-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  `;
	connectedCallback() {
		...
		globalThis.addEventListener("hexos:a2ui-action-status", this.#statusListener);
		this.#syncSurfaces();
	}
	disconnectedCallback() {
		super.disconnectedCallback();
		if (this.#statusListener) {
			globalThis.removeEventListener("hexos:a2ui-action-status", this.#statusListener);
	...
	#handleA2UIAction(evt) {
		...
		globalThis.__hexosLastA2UIAction = userAction;
		const handler = globalThis.webkit?.messageHandlers?.hexosCanvasA2UIAction ?? globalThis.hexosCanvasA2UIAction;
		if (handler?.postMessage) {
			try {
				if (handler === globalThis.hexosCanvasA2UIAction) {
...
customElements.define("hexos-a2ui-host", HexOSA2UIHost);
