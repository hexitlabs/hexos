...
metadata: {"hexos":{"requires":{"bins":["clawdhub"]},"install":[{"id":"node","kind":"node","package":"clawdhub","bins":["clawdhub"],"label":"Install ClawdHub CLI (npm)"}]}}
---
...
- Default workdir: cwd (falls back to HexOS workspace); install dir: ./skills (override with --workdir / --dir / CLAWDHUB_WORKDIR)
