...
### Changes
- Version alignment with core HexOS release numbers.
...
### Highlights
- First public release of the @hexos/voice-call plugin.
...
- CLI: `hexos voicecall` commands (call/start/continue/speak/end/status/tail/expose).
