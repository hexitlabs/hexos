...
import { removeAckReactionAfterReply, shouldAckReaction } from "hexos/plugin-sdk";
import type { HexOSConfig, PluginRuntime } from "hexos/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/hexos") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
