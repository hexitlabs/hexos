...
Nostr DM channel plugin for HexOS using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to HexOS. It enables your bot to:
...
# Configure hexos to use local relay
